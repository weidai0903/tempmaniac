...
public class AccountActivityNew extends FragmentActivity {
    ...
    private String currentPlace = "somewhere";
    ...
    private void onSessionStateChange(Session session, SessionState state, Exception exception) {
        if (pendingAction != PendingAction.NONE &&
                ...
                new AlertDialog.Builder(AccountActivityNew.this)
    ...
    private void postStatusUpdate() {
        if (user != null && hasPublishPermission()) {
            //final String message = getString(R.string.status_update, user.getName(), (new Date().toString()));
        	final String message;
        	//TempOperations to = new TempOperations();
        	//Double temp = to.getLatestReading(true);
        	String temp = TemperatureActivity.getLatestTempReading();
        	if(temp != null) {
        		Log.v("account", "latest temp is " + temp);
        		message = "Temperature in Moore207 is " + temp + ". I am at " + currentPlace;
        	}else {
        		Log.v("account", "fail to get latest temp ");
        		message = "TempManiac is a wonderland!";
        	}
