...
public class DeviceActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		RadioButton rb = (RadioButton)this.findViewById(R.id.radioDeviceCe);
		RadioButton rb2 = (RadioButton)this.findViewById(R.id.radioLedRed);
		rb.setChecked(true);
		rb2.setChecked(true);
		...
		CheckBox cbOnBoard = (CheckBox)this.findViewById(R.id.checkBoxBoard);
		cbOnBoard.setChecked(true);
